...
$.ajax({
  ...
  data: {
    key: 'GJ2BZ-ONM6J-CQCFU-D472F-6EMBV-LUFNH',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(102.661614, 25.095179, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime2() {
  var ascll2 = [`NCC2-036`, `调用前置摄像头拍照成功，识别为「吴彦祖」`, `Photo captured: `, ` 🤪 `];
  ...
  setTimeout(console.log.bind(console, "%c WELCOME %c 欢迎光临，宝贝", "color:white; background-color:#23c682", ""));

  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Macre %c 你正在访问Mcareの小家",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://img.shields.io/badge/Macre-%E5%AD%A6%E4%B9%A0%E5%B7%A5%E4%BD%9C%E4%B8%AD-biue?logo=mega' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://img.shields.io/badge/Macre-%E5%BF%AB%E4%B9%90%E4%BC%91%E6%81%AF%E4%B8%AD-blue?logo=mega' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://source.fomal.cc/img/dm2.webp);
    --darkmode-bg:url(https://th.bing.com/th/id/R.921b22b27d2ae93c0642ef7a37ec01a9?rik=QFAcKEgE5vI3mQ&pid=ImgRaw&r=0);
    --mobileday-bg: url(https://c-ssl.dtstatic.com/uploads/item/201807/31/20180731133228_dUWaH.thumb.1000_0.jpeg);
    --mobilenight-bg: url(https://pic7.sucaisucai.com/00/98/00398917_2.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
